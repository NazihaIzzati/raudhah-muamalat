...
<div class="space-y-6">
    <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 via-white to-gray-50">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-semibold text-gray-900">Create New News Article</h3>
                        <p class="text-sm text-gray-500">Add a new news article to the website</p>
                    </div>
                </div>
        ...
        <!-- Form -->
        <form id="create-news-form" action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" data-confirm="Are you sure you want to create this news article?">
            @csrf
