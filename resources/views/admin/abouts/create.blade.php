...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow-sm border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Create About Content</h1>
                    <p class="mt-1 text-sm text-gray-600">Add new content for the about page</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form id="create-about-form" action="{{ route('admin.abouts.store') }}" method="POST" data-confirm="Are you sure you want to create this about content?">
            @csrf
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Fill in the details for the about page content.</p>
                </div>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="hero_badge_text" id="hero_badge_text" value="{{ old('hero_badge_text') }}"
                            ...
                            <div>
                                ...
                                <textarea name="hero_description" id="hero_description" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                          placeholder="Jariah Fund is Malaysia's premier Shariah-compliant platform...">{{ old('hero_description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea name="mission" id="mission" rows="4"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                          placeholder="Enter the organization's mission...">{{ old('mission') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="vision" id="vision" rows="4"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                          placeholder="Enter the organization's vision...">{{ old('vision') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="values" id="values" rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                      placeholder="Enter the organization's values...">{{ old('values') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="bank_muamalat_title" id="bank_muamalat_title" value="{{ old('bank_muamalat_title') }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                            ...
                            <div>
                                ...
                                <textarea name="bank_muamalat_description" id="bank_muamalat_description" rows="6"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                          placeholder="Enter the Bank Muamalat description...">{{ old('bank_muamalat_description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="payment_section_title" id="payment_section_title" value="{{ old('payment_section_title') }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                            ...
                            <div>
                                ...
                                <textarea name="payment_section_description" id="payment_section_description" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                          placeholder="Choose from Malaysia's most trusted payment methods...">{{ old('payment_section_description') }}</textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <textarea name="fpx_description" id="fpx_description" rows="4"
                                              class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                              placeholder="Enter FPX payment description...">{{ old('fpx_description') }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="duitnow_description" id="duitnow_description" rows="4"
                                              class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                                              placeholder="Enter DuitNow payment description...">{{ old('duitnow_description') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
