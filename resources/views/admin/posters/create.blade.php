...
@section('title', 'Create Poster - Admin Dashboard')
            ...
            <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 via-white to-gray-50">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-xl font-bold text-[#fe5000]">Create New Poster</h3>
                            <p class="text-sm text-[#fe5000] mt-1">Add a new promotional poster with all required details</p>
                        </div>
                    </div>
            ...
            <div class="p-6 space-y-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-center bg-gradient-to-r from-[#fe5000]/10 to-orange-50 p-4 rounded-xl border border-[#fe5000]/20">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-[#fe5000]/70">Enter the poster's basic details</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="group">
                            ...
                            <div class="relative rounded-xl shadow-sm">
                                ...
                                <input type="date" name="display_from" id="display_from" value="{{ old('display_from') }}" 
                        ...
                        <div class="group">
                            ...
                            <div class="relative rounded-xl shadow-sm">
                                ...
                                <input type="date" name="display_until" id="display_until" value="{{ old('display_until') }}" 
                                    class="pl-12 pr-4 py-3 focus:ring-2 focus:ring-[#fe5000] focus:border-transparent block w-full text-sm border border-gray-300 rounded-xl hover:border-[#fe5000] bg-white transition-all duration-200">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        ...
                        <div class="relative rounded-xl shadow-sm">
                            <textarea name="description" id="description" rows="4" 
                                ...
                                placeholder="Brief description of the poster...">{{ old('description') }}</textarea>
                        </div>
                ...
                <div class="space-y-6">
                    <div class="flex items-center bg-gradient-to-r from-[#fe5000]/10 to-orange-50 p-4 rounded-xl border border-[#fe5000]/20">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-semibold text-[#fe5000]">Poster Image</h4>
                            <p class="text-sm text-[#fe5000]/70">Upload the poster image</p>
                        </div>
                    </div>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="poster_image" class="relative cursor-pointer bg-white rounded-md font-medium text-[#fe5000] hover:text-orange-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-[#fe5000]">
                                        ...
                                        <input id="poster_image" name="poster_image" type="file" accept="image/*" class="sr-only" required>
                                    </label>
