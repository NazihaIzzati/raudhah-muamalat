...
│   ├── css/                 # Stylesheets
│   └── js/                  # JavaScript
├── storage/keys/            # Cryptographic keys for all environments
│   ├── dev/                # Development environment keys
│   ├── sit/                # SIT environment keys  
│   ├── prod/               # Production environment keys
│   └── cardzone/           # Cardzone payment keys
├── ssh-keygen/             # Legacy Cardzone keys (deprecated)
├── docs/                    # Documentation
└── tests/                   # Test suites
```
...
- **Private Key**: `storage/keys/cardzone/merchant_private.key` (PEM format)
- **Public Key**: `storage/keys/cardzone/merchant_public.pem` (PEM format)
