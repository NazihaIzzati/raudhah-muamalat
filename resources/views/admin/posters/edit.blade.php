...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <form action="{{ route('admin.posters.update', $poster) }}" method="POST" enctype="multipart/form-data" class="p-6">
        @csrf
        @method('PUT')
        
        <!-- Header -->
        <div class="border-b border-gray-200 pb-5 mb-5">
            <h3 class="text-lg leading-6 font-medium text-gray-900">Edit Poster</h3>
            <p class="mt-1 text-sm text-gray-500">Update poster information.</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            <div class="sm:col-span-4">
                ...
                <div class="mt-1">
                    <input type="text" name="title" id="title" value="{{ old('title', $poster->title) }}" class="shadow-sm focus:ring-orange-500 focus:border-orange-500 block w-full sm:text-sm border-gray-300 rounded-md">
                </div>
            </div>
            ...
            <div class="sm:col-span-6">
                ...
                <div class="mt-1">
                    <textarea id="description" name="description" rows="3" class="shadow-sm focus:ring-orange-500 focus:border-orange-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('description', $poster->description) }}</textarea>
                </div>
            ...
            @if($poster->image_path)
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-2">
                        <img src="{{ asset('storage/' . $poster->image_path) }}" alt="{{ $poster->title }}" class="max-h-64 rounded-md">
                    </div>
                </div>
            @endif
            ...
            <!-- Poster Image -->
            <div class="sm:col-span-6">
                <label for="poster_image" class="block text-sm font-medium text-gray-700">Update Poster Image</label>
            ...
            <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $poster->display_order) }}" min="0" class="shadow-sm focus:ring-orange-500 focus:border-orange-500 block w-full sm:text-sm border-gray-300 rounded-md">
                </div>
            ...
            <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    <input type="date" name="display_from" id="display_from" value="{{ old('display_from', $poster->display_from?->format('Y-m-d')) }}" class="shadow-sm focus:ring-orange-500 focus:border-orange-500 block w-full sm:text-sm border-gray-300 rounded-md">
                </div>
            </div>
            ...
            <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    <input type="date" name="display_until" id="display_until" value="{{ old('display_until', $poster->display_until?->format('Y-m-d')) }}" class="shadow-sm focus:ring-orange-500 focus:border-orange-500 block w-full sm:text-sm border-gray-300 rounded-md">
                </div>
            </div>
        </div>
