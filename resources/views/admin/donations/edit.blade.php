    ...
    <div class="p-6 bg-white border-b border-gray-200">
        <form action="{{ route('admin.donations.update', $donation) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="donor_name" id="donor_name" value="{{ old('donor_name', $donation->donor_name) }}" class="mt-1 focus:ring-orange-500 focus:border-orange-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                @error('donor_name')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="email" name="donor_email" id="donor_email" value="{{ old('donor_email', $donation->donor_email) }}" class="mt-1 focus:ring-orange-500 focus:border-orange-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                                @error('donor_email')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="donor_phone" id="donor_phone" value="{{ old('donor_phone', $donation->donor_phone) }}" class="mt-1 focus:ring-orange-500 focus:border-orange-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                @error('donor_phone')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div>
                        ...
                        <textarea name="message" id="message" rows="3" class="mt-1 focus:ring-orange-500 focus:border-orange-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('message', $donation->message) }}</textarea>
                        @error('message')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="is_anonymous" name="is_anonymous" type="checkbox" class="focus:ring-orange-500 h-4 w-4 text-orange-600 border-gray-300 rounded" {{ old('is_anonymous', $donation->is_anonymous) ? 'checked' : '' }}>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input type="number" name="amount" id="amount" value="{{ old('amount', $donation->amount) }}" min="0.01" step="0.01" class="focus:ring-orange-500 focus:border-orange-500 block w-full pr-12 sm:text-sm border-gray-300 rounded-md" required>
                                    </div>
                                    @error('amount')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="transaction_id" id="transaction_id" value="{{ old('transaction_id', $donation->transaction_id) }}" class="mt-1 focus:ring-orange-500 focus:border-orange-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    ...
                    <div class="bg-gray-50 p-4 rounded-md">
                        <h3 class="text-sm font-medium text-gray-700 mb-2">Donation Information</h3>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <p class="text-xs text-gray-500">Created At</p>
                                <p class="text-sm font-medium">{{ $donation->created_at->format('M d, Y H:i') }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">Paid At</p>
                                <p class="text-sm font-medium">{{ $donation->paid_at ? $donation->paid_at->format('M d, Y H:i') : 'Not paid yet' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-8 flex justify-end">
                <a href="{{ route('admin.donations.show', $donation) }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 mr-2">
                    Cancel
                </a>
