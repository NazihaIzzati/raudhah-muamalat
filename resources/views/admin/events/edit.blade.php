...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <form action="{{ route('admin.events.update', $event) }}" method="POST" enctype="multipart/form-data" class="p-6">
        ...
        <div class="border-b border-gray-200 pb-5 mb-6 flex justify-between items-start">
            <div>
                <h3 class="text-lg leading-6 font-medium text-gray-900">Edit Event Information</h3>
                <p class="mt-1 text-sm text-gray-500">Update event details and settings.</p>
            </div>
            <a href="{{ route('admin.events.show', $event) }}" class="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#fe5000]">
        ...
        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            <div class="sm:col-span-6 mb-6">
                ...
                <div class="mt-1 relative group">
                    ...
                    <textarea name="content" id="content" rows="6" 
                        class="pl-10 shadow-sm focus:ring-[#fe5000] focus:border-[#fe5000] block w-full text-base border border-gray-300 rounded-lg hover:border-[#fe5000] py-3 px-4 transition-all duration-200" 
                        placeholder="Detailed event information, agenda, speakers, etc...">{{ old('content', $event->content) }}</textarea>
                </div>
            </div>
            ...
            <div class="sm:col-span-2 mb-6">
                ...
                <div class="mt-1 flex items-center space-x-4">
                    <label class="inline-flex items-center">
                        <input type="radio" name="registration_required" value="1" {{ old('registration_required', $event->registration_required) == '1' ? 'checked' : '' }} 
                            class="focus:ring-[#fe5000] h-4 w-4 text-[#fe5000] border-gray-300">
                        <span class="ml-2 text-sm text-gray-700">Yes</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" name="registration_required" value="0" {{ old('registration_required', $event->registration_required) == '0' ? 'checked' : '' }} 
                            class="focus:ring-[#fe5000] h-4 w-4 text-[#fe5000] border-gray-300">
            ...
            <div class="sm:col-span-2 mb-6">
                ...
                <div class="mt-1 relative group">
                    ...
                    <input type="number" name="registration_fee" id="registration_fee" value="{{ old('registration_fee', $event->registration_fee) }}" 
                ...
                <div class="mt-1 relative group">
                    ...
                    <select id="currency" name="currency" 
                        ...
                        @foreach($currencies as $value => $label)
                            <option value="{{ $value }}" {{ old('currency', $event->currency) == $value ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                    <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-500">
                        <svg class="h-5 w-5 group-hover:text-[#fe5000] transition-colors duration-200" fill="currentColor" viewBox="0 0 20 20">
            ...
            @if($event->featured_image)
                <div class="sm:col-span-6 mb-6">
                    ...
                    <div class="mt-1">
                        <img src="{{ asset('storage/' . $event->featured_image) }}" alt="{{ $event->title }}" class="h-32 w-32 object-cover rounded-lg border-2 border-[#fe5000]/20 shadow-sm">
                    </div>
                </div>
            @endif
            ...
            <!-- Featured Image -->
            <div class="sm:col-span-6 mb-6">
                <label for="featured_image" class="block text-sm font-medium text-gray-700 mb-1.5">{{ $event->featured_image ? 'Replace Featured Image' : 'Featured Image' }}</label>
        ...
        <div class="pt-6 border-t border-gray-200">
            <div class="flex justify-end space-x-3">
                <a href="{{ route('admin.events.show', $event) }}" class="bg-white py-2.5 px-5 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#fe5000] transition-colors duration-200">
                    Cancel
                </a>
