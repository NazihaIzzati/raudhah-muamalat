            ...
            <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 via-white to-gray-50">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-xl font-bold text-[#fe5000]">Create New Event</h3>
                            <p class="text-sm text-[#fe5000] mt-1">Add a new event with all required details</p>
                        </div>
                    </div>
            ...
            <div class="p-6 space-y-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-center bg-gradient-to-r from-[#fe5000]/10 to-orange-50 p-4 rounded-xl border border-[#fe5000]/20">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-[#fe5000]/70">Enter the event's basic details</p>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="flex items-center bg-gradient-to-r from-[#fe5000]/10 to-orange-50 p-4 rounded-xl border border-[#fe5000]/20">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-semibold text-[#fe5000]">Date & Time Information</h4>
                            <p class="text-sm text-[#fe5000]/70">Set the event schedule and timing</p>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="flex items-center bg-gradient-to-r from-[#fe5000]/10 to-orange-50 p-4 rounded-xl border border-[#fe5000]/20">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-semibold text-[#fe5000]">Location Information</h4>
                            <p class="text-sm text-[#fe5000]/70">Set the event location and venue details</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="group sm:col-span-2">
                            ...
                            <div class="relative rounded-xl shadow-sm">
                                ...
                                <input type="text" name="location" id="location" value="{{ old('location') }}" 
                                    class="pl-12 pr-4 py-3 focus:ring-2 focus:ring-[#fe5000] focus:border-transparent block w-full text-sm border border-gray-300 rounded-xl hover:border-[#fe5000] bg-white transition-all duration-200 placeholder-gray-400" 
                                    placeholder="Enter venue name or location..." required>
                            </div>
                        </div>
                        ...
                        <div class="group sm:col-span-2">
                            <label for="address" class="block text-sm font-semibold text-gray-700 mb-2">
                                Full Address <span class="text-gray-400 text-xs">(Optional)</span>
                            </label>
                            <div class="relative rounded-xl shadow-sm">
                                <div class="absolute top-3 left-4 flex items-start pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-hover:text-[#fe5000] transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <textarea name="address" id="address" rows="2" 
                                    class="pl-12 pr-4 py-3 focus:ring-2 focus:ring-[#fe5000] focus:border-transparent block w-full text-sm border border-gray-300 rounded-xl hover:border-[#fe5000] bg-white transition-all duration-200 placeholder-gray-400" 
                                    placeholder="Complete address with postal code...">{{ old('address') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="flex items-center bg-gradient-to-r from-[#fe5000]/10 to-orange-50 p-4 rounded-xl border border-[#fe5000]/20">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-semibold text-[#fe5000]">Registration Settings</h4>
                            <p class="text-sm text-[#fe5000]/70">Configure event registration and participation</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="group">
                            <label for="max_participants" class="block text-sm font-semibold text-gray-700 mb-2">
                                Max Participants <span class="text-gray-400 text-xs">(Optional)</span>
                            </label>
                            <div class="relative rounded-xl shadow-sm">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-hover:text-[#fe5000] transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="group">
                            <label for="registration_fee" class="block text-sm font-semibold text-gray-700 mb-2">
                                Registration Fee <span class="text-gray-400 text-xs">(Optional)</span>
                            </label>
                            <div class="relative rounded-xl shadow-sm">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <span class="text-gray-400 group-hover:text-[#fe5000] transition-colors duration-200 text-sm font-medium">RM</span>
                                </div>
                            ...
                            <div class="relative">
                                <select id="currency" name="currency" 
                                    ...
                                    @foreach($currencies as $value => $label)
                                        <option value="{{ $value }}" {{ old('currency', 'MYR') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-gray-500">
                                    <svg class="h-5 w-5 group-hover:text-[#fe5000] transition-colors duration-200" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="group">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center">
                                    <input id="registration_required" name="registration_required" type="checkbox" value="1" {{ old('registration_required', true) ? 'checked' : '' }}
                                        class="h-4 w-4 text-[#fe5000] focus:ring-[#fe5000] border-gray-300 rounded">
                                    <label for="registration_required" class="ml-3 text-sm text-gray-700">
                                        Registration Required
                                        <span class="text-gray-400 text-xs block">Require users to register for this event</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="space-y-6">
                    <div class="flex items-center bg-gradient-to-r from-[#fe5000]/10 to-orange-50 p-4 rounded-xl border border-[#fe5000]/20">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-[#fe5000]/70">Upload event images and media files</p>
                        </div>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-6 border-t border-gray-200">
                    <a href="{{ route('admin.events.index') }}" class="inline-flex justify-center items-center px-8 py-3 border border-gray-300 shadow-sm text-sm font-semibold rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#fe5000] transition-all duration-200">
                        Cancel
                    </a>
