...
@section('title', 'Create FAQ - Admin Dashboard')
            ...
            <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 via-white to-gray-50">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-xl font-bold text-[#fe5000]">Create New FAQ</h3>
                            <p class="text-sm text-[#fe5000] mt-1">Add a new frequently asked question and answer</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="group">
                            ...
                            <div class="relative rounded-xl shadow-sm">
                                ...
                                <input type="number" name="display_order" id="display_order" value="{{ old('display_order', 0) }}" min="0" step="1" 
